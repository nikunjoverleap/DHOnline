...
import StyleSheetFactory from './ImageItemContainerStyle';
import { env } from '../../src/config/env';
import { logInfo } from '../../helper/Global';
import InAppBrowser from 'react-native-inappbrowser-reborn';

export const ImageItemContainer = ({
  item,
  widgetCount,
  rowData,
  onPressImage,
        ...
        {rowData?.widgets?.length > 1 ? (
          item?.title ? (
            <Text
              numberOfLines={1}
              style={[
                styles.imageItemContainerTitleTextStyle,
                {
                  fontSize: isCategorieScreen ? 13 : 12,
                  marginBottom: 5,
                },
              ]}
            >
